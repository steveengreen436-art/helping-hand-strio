  ...
  return (
    <div className="bg-[#112240] border border-cyan-500/50 rounded-3xl p-6 my-6 shadow-2xl">
      ...
      <div className="text-center mb-6">
        <h1 className="text-2xl font-black text-cyan-400">JOIN THE ESWATINI WORKFORCE!</h1>
        <p className="text-sm italic text-gray-400">Empowering Eswatini - Job Seekers Wanted</p>
      </div>
      ...
      <div className="bg-black/40 p-4 rounded-xl text-center border border-cyan-800">
        ...
        <a href="mailto:helpinghandstrio@gmail.com" className="text-cyan-400 font-bold block hover:underline">
